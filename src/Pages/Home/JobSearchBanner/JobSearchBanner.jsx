      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <input
            ...
            className="w-full p-4 rounded-md text-gray-800 bg-white placeholder-gray-500"
          />
        </div>

        {/* Navigation Buttons */}
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <button className="bg-white text-blue-600 font-semibold px-5 py-2 rounded hover:bg-gray-100 transition">
        ...
        {/* Show More */}
        <p className="text-sm underline text-orange-200 hover:text-white cursor-pointer">

...
// Trending Searches (You can add more)
const trending = [
  "Remote Jobs",
  "Data Analyst",
  "Frontend Developer",
    ...
    <section className="bg-white dark:bg-slate-900 py-16 px-6 md:px-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="relative">
          <img
            src="https://www.workitdaily.com/media-library/man-starts-his-new-job.jpg?id=27287891&width=1200&height=800&quality=50&coordinates=0%2C0%2C0%2C0"
            alt="Remote worker"
